...
class LetterAdapter(
...
) : androidx.recyclerview.widget.RecyclerView.Adapter<LetterAdapter.LetterViewHolder>() {
    ...
    inner class LetterViewHolder(view: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(view), View.OnClickListener {
